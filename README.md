...
> 数据修复状态：同源复核已确认 Model Y 和 Model 3 的原始快照存在缺口，并修复测试期 12 个车系月；两款车的 2024-06 至 2025-12 历史仍待补齐。因此上表是修复前快照上的冻结基准，暂不据此更新结论；完整修复后将重新训练并重新计算全部对照指标。详见[数据修复审计](./data/README.md#数据质量与修复processeddata_quality)。
